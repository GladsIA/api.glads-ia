...
export async function POST(request) {
    ...
    const { Client } = await import('@hubspot/api-client'); // import dinâmico
    const hubspotClient = new Client({ accessToken: process.env.AUTOMACAO_OC_APP_HUBSPOT_ACCESS_TOKEN });
